...
public final class RgbYuv {
    ...
    /**
     * Calculates the lookup table. <b>MUST</b> be called (only once) before
     * doing anything else
     */
    ...
    /**
     * Releases the reference to the lookup table. <b>The table has to be
     * calculated again for the next lookup.</b>
     */
